...
<html lang="pt-Br">
<head>
<title><?php echo $_SESSION['nome_usuario']; ?></title>
...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" href="./"><span class="fa fa-area-chart"></span>   TÓTUS<span class="dashboard_text">Sistema de Gestão</span></a></h1>
          </div>
	...
	<!--footer-->
	<div class="footer">
	   <p>&copy; 2022 TÓTUS SYSTEMS All Rights Reserved. <a href="#" target="_blank">Sistemas para gestão.</a></p>		
	</div>
    <!--//footer-->
	</div>
      	...
      	<div class="row">
      		<div class="col-md-6">
		      	<div class="form-group">
			    	<input type="text" name="nome_usu" id="usuario" class="form-control" placeholder="<?php echo $nome_usu ?>" >
		      </div>
		    </div>
      		<div class="col-md-6">
      			<input type="text" name="cpf_usu" id="usuario" class="form-control" placeholder="<?php echo $cpf_usu ?>" >
      		</div>
